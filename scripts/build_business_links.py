...
INVEST_AGENCIES = {
    ...
    "BTN": ["Invest Bhutan", "https://investbhutan.gov.bt"],
    ...
    "BRN": ["Brunei Economic Development Board (BEDB)", "https://www.bedb.gov.bn"],
    "BGR": ["InvestBulgaria Agency", "https://www.investbg.government.bg"],
    "BFA": ["Burkinabe Investment Agency (ABI)", "https://www.investburkina.com"],
    "BDI": ["Burundi Development Agency (ADB)", "https://investburundi.bi"],
    "KHM": ["Council for the Development of Cambodia (CDC)", "https://cdc.gov.kh"],
    "CMR": ["Cameroon Investment Promotion Agency (CIPA)", "https://www.prc.cm/en/invest-in-cameroon/api"],
    "CAN": ["Invest Canada", "https://www.investcanada.ca"],
    "CPV": ["Cabo Verde TradeInvest (CVTI)", "https://www.cvtradeinvest.cv"],
    ...
    "COD": ["National Agency for Investment Promotion (ANAPI)", "https://anapi.cd/en"],
    "COG": ["Agency for Promotion of Investments (API)", "https://apicongo.cg/index.php?lang=en"],
    ...
    "CUB": ["ProCuba — Investment Portal", "https://inviertaencuba.mincex.gob.cu/en"],
    ...
    "DJI": ["Djibouti National Investment Promotion Agency (NIPA)", "https://www.djiboutinvest.com"],
    ...
    "SLV": ["INVEST El Salvador", "https://investinelsalvador.gob.sv"],
    "GNQ": ["Ministry of Mines, Industry & Energy", None],
    "ERI": ["Eritrea Investment Center", None],
    "EST": ["Enterprise Estonia", "https://www.eas.ee/en"],
    "SWZ": ["Eswatini Investment Promotion Authority (EIPA)", "https://investeswatini.org.sz"],
    ...
    "GAB": ["Gabon National Investment Promotion Agency (ANPI-GABON)", "https://investingabon.ga"],
    "GMB": ["Gambia Investment & Export Promotion Agency (GIEPA)", "https://www.giepa.gm"],
    "GEO": ["Invest in Georgia", "https://investingeorgia.org"],
    "DEU": ["Germany Trade & Invest (GTAI)", "https://www.gtai.de/en"],
    "GHA": ["Ghana Investment Promotion Centre (GIPC)", "https://gipc.gov.gh"],
    "GRC": ["Enterprise Greece", "https://www.enterprisegreece.gov.gr"],
    "GTM": ["Invest Guatemala", "https://investguatemala.com"],
    "GIN": ["Agency for the Promotion of Private Investments (APIP-Guinea)", None],
    "GNB": ["Center for Investment Promotion (CPI)", None],
    "GUY": ["Guyana Office for Investment (GO-Invest)", "https://www.guyanainvest.gov.gy"],
    "HTI": ["Center for Investment Facilitation (CFI)", None],
    "HND": ["National Investment Council (CNI)", "https://www.cni.hn/language/en"],
    ...
    "JAM": ["Jamaica Promotions Corporation (JAMPRO)", "https://dobusinessjamaica.com"],
    ...
    "KAZ": ["Kazakh Invest", "https://invest.gov.kz"],
    ...
    "KGZ": ["National Investments Agency of Kyrgyzstan", "https://invest.gov.kg"],
    ...
    "LSO": ["Lesotho National Development Corporation (LNDC)", "https://lndc.org.ls"],
    "LBR": ["Liberia National Investment Commission", "https://www.investliberia.gov.lr"],
    ...
    "MWI": ["Malawi Investment & Trade Centre (MITC)", "https://mitc.mw"],
    "MYS": ["Malaysian Investment Development Authority (MIDA)", "https://www.mida.gov.my"],
    "MDV": ["Invest Maldives", "https://investmaldives.gov.mv"],
    "MLI": ["Mali Investment Promotion Agency (API-Mali)", "https://apimali.gov.ml/en"],
    ...
    "MCO": ["Monaco Economic Board — Invest Monaco", "https://www.meb.mc/en/invest-monaco"],
    "MNG": ["Investment and Trade Agency of Mongolia", "https://investmongolia.gov.mn"],
    "MNE": ["Montenegrin Investment Agency (MIA)", "https://mia.gov.me/en"],
    ...
    "MMR": ["Directorate of Investment & Company Administration (DICA)", "https://dica.gov.mm/en"],
    "NAM": ["Namibia Investment Promotion & Development Board (NIPDB)", "https://www.nipdb.com"],
    ...
    "ZWE": ["Zimbabwe Investment & Development Agency (ZIDA)", "https://zidainvest.com"],
    "CIV": ["Centre for Investment Promotion in Côte d'Ivoire (CEPICI)", "https://www.cepici.gouv.ci"],
    "VUT": ["Vanuatu Investment Promotion Authority (VIPA)", "https://investvanuatu.vu"],
    "SLB": ["InvestSolomons", "https://www.investsolomons.gov.sb"],
    "WSM": ["Ministry of Commerce, Industry & Labour", "https://mcil.gov.ws"],
    "TON": ["Invest in Tonga", "https://www.investtonga.gov.to"],
    ...
    "STP": ["São Tomé & Príncipe Trade & Investment Promotion Agency (APCI)", "https://www.apci.gov.st"],
    "NRU": ["Nauru Agency Corporation", None],
    "TUV": ["Pacific Islands Trade & Invest (Regional)", None],
    "KIR": ["Investment Promotion Division, Kiribati", "https://mcic.gov.ki/investment-promotion-office"],
    "FSM": ["Micronesia Investment & Development Corporation (MIDC)", None],
    "PLW": ["Palau Foreign Investment Board", "https://www.palaugov.pw/fib"],
    "MHL": ["Office of Commerce, Investment & Tourism (OCIT)", "https://www.ocit.mh"],
    "AND": ["Andorra Business", None],
    "LIE": ["Liechtenstein Economic Affairs", "https://www.llv.li/en/private-persons/economy"],
    "SMR": ["San Marino Agency for Economic Development", "https://www.agency.sm/en"],
    "SOM": ["Somalia Investment Promotion Office (SOMINVEST)", "https://sominvest.gov.so"],
    "AZE": ["Azerbaijan Export & Investment Promotion Agency (AZPROMO)", "https://azpromo.az/en"],
    "ARM": ["Enterprise Armenia", "https://enterprisearmenia.am"],
    "GEO": ["Invest in Georgia", "https://investingeorgia.org"],
    "BLZ": ["Belize Trade & Investment Development Service (BELTRAIDE)", "https://beltraide.bz"],
    "PAN": ["ProPanamá", "https://propanama.org/en"],
    "SLE": ["Sierra Leone Investment & Export Promotion Agency (SLIEPA)", "https://www.sliepa.gov.sl"],
    "TGO": ["Investment Promotion & Free Zone Agency (API-ZF)", "https://investirautogo.tg"],
    "TLS": ["TradeInvest Timor-Leste", "https://www.tradeinvest.tl"],
    "PNG": ["Investment Promotion Authority PNG (IPA)", "https://www.investpng.com"],
    "SUR": ["Suriname Investment & Trade Agency (SITA)", "https://sita.sr"],
    "AGO": ["Angola Private Investment & Export Promotion Agency (AIPEX)", None],
    "SSD": ["South Sudan Ministry of Investment", "https://investment.eservices.gov.ss"],
}
